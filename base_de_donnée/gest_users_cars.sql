...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 01 déc. 2023 à 20:50
...
--
-- Base de données : `gest_users_cars`
--
...
(5, '2023_11_30_163654_create_members_table', 1),
(6, '2023_11_30_163710_create_cars_table', 1);
...
CREATE TABLE `users` (
  ...
  `role` varchar(255) NOT NULL DEFAULT 'gestionnaire',
...
ALTER TABLE `cars`
  ...
  ADD KEY `cars_member_id_foreign` (`member_id`);
...
--
ALTER TABLE `cars`
  ADD CONSTRAINT `cars_member_id_foreign` FOREIGN KEY (`member_id`) REFERENCES `members` (`id`) ON DELETE CASCADE,
